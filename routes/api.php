...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::prefix('menu-items')->name('api.menu-items.')->group(function () {
        ...
        // Menu item actions
        Route::post('/{menuItem}/duplicate', [MenuItemController::class, 'duplicate'])->name('duplicate');
        Route::post('/reorder', [MenuItemController::class, 'reorder'])->name('reorder');
        Route::post('/bulk-from-pages', [MenuItemController::class, 'bulkCreateFromPages'])->name('bulk-from-pages');
    });
