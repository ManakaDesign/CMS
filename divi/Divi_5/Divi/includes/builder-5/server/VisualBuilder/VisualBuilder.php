...
class VisualBuilder {
	...
	public function initialize(): void {
		...
		$post_type = isset( $_GET['post'] ) ? get_post_type( intval( $_GET['post'] ) ) : ( isset( $_GET['post_type'] ) ? sanitize_key( $_GET['post_type'] ) : false ); // phpcs:ignore WordPress.Security.NonceVerification -- Nonce verification is not required here.
