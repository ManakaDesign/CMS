...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <link rel="icon" type="image/svg+xml" href="/public/admin/vite.svg" />
    ...
    <script type="module" crossorigin src="/public/admin/assets/index-CFJ4LZj7.js"></script>
    <link rel="stylesheet" crossorigin href="/public/admin/assets/index-BpHlzUZh.css">
  </head>
  <body>
    <div id="root"></div>
  </body>
