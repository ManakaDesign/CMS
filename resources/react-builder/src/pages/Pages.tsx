...
type TabType = 'pages' | 'posts' | 'projects';
    ...
    <MainLayout>
      ...
      <header className="bg-dark-surface border-b border-dark-border">
        <div className="px-6 py-4">
          <h1 className="text-2xl font-bold text-light-text">Seiten</h1>
          <p className="text-sm text-light-muted mt-1">Verwalte deine Seiten, Beiträge und Projekte</p>
        </div>
      </header>
      ...
      <main className="flex-1 overflow-y-auto p-6">
        ...
        {activeTab === 'posts' && (
          <div className="bg-dark-panel border border-dark-border rounded-lg p-12 text-center">
            <FiFileText className="mx-auto text-light-muted mb-4" size={64} />
            <h2 className="text-xl font-semibold text-light-text mb-2">Beiträge</h2>
            <p className="text-light-muted mb-4">
              Verwalte deine Blog-Beiträge mit Drag & Drop Sortierung
            </p>
            <p className="text-sm text-light-muted">
              Features: Erstellen, Sortieren, Kategorien, Tags
            </p>
        ...
        {activeTab === 'projects' && (
          <div className="bg-dark-panel border border-dark-border rounded-lg p-12 text-center">
            <FiFileText className="mx-auto text-light-muted mb-4" size={64} />
            <h2 className="text-xl font-semibold text-light-text mb-2">Projekte</h2>
            <p className="text-light-muted mb-4">
              Verwalte deine Projekte mit Drag & Drop Sortierung
            </p>
            <p className="text-sm text-light-muted">
              Features: Erstellen, Sortieren, Portfolio-Ansicht
            </p>
            <p className="text-sm text-light-muted mt-2">Wird in Kürze implementiert</p>
          </div>
        )}
