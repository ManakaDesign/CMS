	...
	public static function render( array $args ): string {
		...
		if ( is_callable( $styles_component ) ) {
			...
			if ( $selector_classname ) {
				...
				// Skip styles generation for loop iterations after the first one to prevent CSS duplication.
				$loop_iteration         = $attrs_with_loop_context['__loop_iteration'] ?? 0;
				$should_generate_styles = ! $is_style_enqueued_as_static_css && ( 0 === $loop_iteration );
